...
const buildStarSvg = (innerItems: string, viewBox: string = DEFAULT_STAR_VIEWBOX) => ({
  viewBox,
  items: `
...
const addRatingButton = (extension: IExtensionObject<TestConfig>, config: RatingButtonConfig): void => {
